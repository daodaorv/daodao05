...
(
    ...
    '[{"day":1,"title":"成都-雅安-泸定","content":"早上从成都出发，途经雅安，抵达泸定，参观泸定桥"},{"day":2,"title":"泸定-康定-新都桥","content":"前往康定，翻越折多山，抵达摄影天堂新都桥"}]',
    '["房车租赁费", "领队服务费", "营地费用", "基础保险"]',
    '["餐饮费用", "景区门票", "个人消费", "额外保险"]',
    '["需提前7天预订", "需支付定金2000元", "需提供驾驶证复印件", "高原地区注意身体状况"]',
    '["出发前15天取消全额退款", "出发前7-15天取消退款70%", "出发前7天内取消退款30%"]',
    'ACTIVE'
);
